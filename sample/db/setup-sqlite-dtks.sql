...
CREATE TABLE IF NOT EXISTS anggota_kpm (
  ...
  usia              INT,
  FOREIGN KEY (kpm_id) REFERENCES keluarga_penerima_manfaat(kpm_id)
);

CREATE TABLE IF NOT EXISTS program_kpm (
  kpm_program_id   INTEGER PRIMARY KEY AUTOINCREMENT,
  kpm_id           INT,
...
INSERT OR IGNORE INTO keluarga_penerima_manfaat (no_ktp_kepala, nama_kepala_keluarga, no_kk, desil_kesejahteraan, status_kemiskinan, sumber_data) VALUES
...
INSERT OR IGNORE INTO anggota_kpm (kpm_id, no_ktp_anggota, nama_anggota, hubungan_keluarga, usia) VALUES
...
INSERT OR IGNORE INTO program_kpm (kpm_id, kode_program, nama_program, tgl_penetapan, status_aktif) VALUES
  (1,  'PKH',    'Program Keluarga Harapan',     '2023-01-01', 1),
  (1,  'BPNT',   'Bantuan Pangan Non Tunai',     '2023-01-01', 1),
  (2,  'BPNT',   'Bantuan Pangan Non Tunai',     '2023-06-01', 1),
  (3,  'BST',    'Bantuan Sosial Tunai',         '2023-01-01', 1),
  (4,  'PKH',    'Program Keluarga Harapan',     '2023-03-01', 1),
  (5,  'BST',    'Bantuan Sosial Tunai',         '2023-01-01', 0),
  (6,  'PKH',    'Program Keluarga Harapan',     '2022-01-01', 1),
  (7,  'BLT_DD', 'BLT Dana Desa',               '2023-07-01', 1),
  (8,  'PKH',    'Program Keluarga Harapan',     '2022-06-01', 1),
  (9,  'BPNT',   'Bantuan Pangan Non Tunai',     '2024-01-01', 1),
  (9,  'BST',    'Bantuan Sosial Tunai',         '2024-01-01', 1),
  (10, 'PKH',    'Program Keluarga Harapan',     '2023-01-01', 1),
  (11, 'BST',    'Bantuan Sosial Tunai',         '2023-01-01', 1),
  (11, 'BLT_DD', 'BLT Dana Desa',               '2023-07-01', 1),
  (12, 'PKH',    'Program Keluarga Harapan',     '2022-06-01', 1);
