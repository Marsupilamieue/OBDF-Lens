...
CREATE TABLE IF NOT EXISTS kunjungan (
  ...
  peserta_id       INT REFERENCES peserta(peserta_id),
  faskes_id        INT REFERENCES fasilitas_kesehatan(faskes_id),
  tgl_kunjungan    DATE,
...
INSERT INTO fasilitas_kesehatan (kode_faskes, nama_faskes, jenis_faskes, wilayah_kode) VALUES
...
INSERT INTO peserta (no_ktp, nama_peserta, kelas_layanan, jenis_kepesertaan, status_aktif, tgl_daftar) VALUES
...
-- Kunjungan (15 baris)
INSERT INTO kunjungan (peserta_id, faskes_id, tgl_kunjungan, diagnosa, biaya, ditanggung_bpjs) VALUES
